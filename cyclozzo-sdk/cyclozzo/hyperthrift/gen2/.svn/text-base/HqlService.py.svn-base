...
import cyclozzo.hyperthrift.gen.ClientService
from ttypes import *
...
class Iface(cyclozzo.hyperthrift.gen.ClientService.Iface):
  """
...
class Client(cyclozzo.hyperthrift.gen.ClientService.Client, Iface):
  """
  HQL service is a superset of Client service
  ...
  def __init__(self, iprot, oprot=None):
    cyclozzo.hyperthrift.gen.ClientService.Client.__init__(self, iprot, oprot)
...
class Processor(cyclozzo.hyperthrift.gen.ClientService.Processor, Iface, TProcessor):
  def __init__(self, handler):
    cyclozzo.hyperthrift.gen.ClientService.Processor.__init__(self, handler)
  ...
  def process_hql_exec(self, seqid, iprot, oprot):
    ...
    except cyclozzo.hyperthrift.gen.ttypes.ClientException, e:
      result.e = e
...
class hql_exec_result:
  ...
  thrift_spec = (
    ...
    (1, TType.STRUCT, 'e', (cyclozzo.hyperthrift.gen.ttypes.ClientException, cyclozzo.hyperthrift.gen.ttypes.ClientException.thrift_spec), None, ), # 1
  )
