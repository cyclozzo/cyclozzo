...
/* Here begins the channel API */

goog.appengine.Channel = function(channelId) {
  this.channelId_ = channelId
};
goog.appengine.Channel.prototype.open = function(opt_handler) {
  opt_handler = opt_handler || new goog.appengine.Socket.Handler;
  return new goog.appengine.Socket(this.channelId_, opt_handler)
};
goog.appengine.Socket = function(channelId, handler) {
...
goog.appengine.Socket.POLLING_TIMEOUT_MS = 0;
goog.appengine.Socket.BASE_URL = "/_ah/subscribe/";
goog.appengine.Socket.BASE_PUBLISH_URL = "/_ah/publish/";
goog.appengine.Socket.ReadyState = {CONNECTING:0, OPEN:1, CLOSING:2, CLOSED:3};
a = goog.appengine.Socket.prototype;
a.getUrl_ = function(command) {
  var url;
  if (command == "connect")
    url = "/_ah/dev/null";
  else 
    url = goog.appengine.Socket.BASE_URL + "?id=" + this.channelId_;
  if(this.clientId_) {
...
a.connect_ = function(e) {
  ...
  if(xhr.isSuccess()) {
    ...
    this.onopen();
    this.win_.setTimeout(goog.bind(this.poll_, this), goog.appengine.Socket.POLLING_TIMEOUT_MS)
  }else {
...
a.send = function(data) {
  if(this.readyState != goog.appengine.Socket.ReadyState.OPEN) {
    return false
  }
  var url = goog.appengine.Socket.BASE_PUBLISH_URL, sendData = new goog.Uri.QueryData;
...
goog.appengine.Socket.Handler = function() {
};
goog.appengine.Socket.Handler.prototype.onopen = function() {
};
goog.appengine.Socket.Handler.prototype.onmessage = function() {
};
goog.appengine.Socket.Handler.prototype.onerror = function() {
};
goog.appengine.Socket.Handler.prototype.onclose = function() {
};
goog.exportSymbol("goog.appengine.Channel", goog.appengine.Channel);
goog.exportSymbol("goog.appengine.Channel.prototype.open", goog.appengine.Channel.prototype.open);
goog.exportSymbol("goog.appengine.Socket.Handler", goog.appengine.Socket.Handler);
goog.exportSymbol("goog.appengine.Socket.Handler.prototype.onopen", goog.appengine.Channel.prototype.onopen);
goog.exportSymbol("goog.appengine.Socket.Handler.prototype.onmessage", goog.appengine.Socket.Handler.prototype.onmessage);
goog.exportSymbol("goog.appengine.Socket.Handler.prototype.onerror", goog.appengine.Socket.Handler.prototype.onerror);
goog.exportSymbol("goog.appengine.Socket.Handler.prototype.onclose", goog.appengine.Socket.Handler.prototype.onclose);
goog.exportSymbol("goog.appengine.Socket", goog.appengine.Socket);
goog.exportSymbol("goog.appengine.Socket.ReadyState", goog.appengine.Socket.ReadyState);
goog.exportSymbol("goog.appengine.Socket.prototype.send", goog.appengine.Socket.prototype.send);
goog.exportSymbol("goog.appengine.Socket.prototype.close", goog.appengine.Socket.prototype.close); })()
