...
def CreateUploadDispatcher(get_blob_storage=GetBlobStorage):
  ...
  class UploadDispatcher(appserver.URLDispatcher):
    ...
    def __init__(self):
      ...
      """
      self.__cgi_handler = appserver_upload.UploadCGIHandler(
          get_blob_storage())
    ...
    def EndRedirect(self, redirected_outfile, original_outfile):
      ...
      code.
      """
      response = appserver.RewriteResponse(redirected_outfile)
      ...
      if (response.status_code in (301, 302, 303) and
        ...
        appserver.URLDispatcher.EndRedirect(self,
                                                contentless_outfile,
                                                original_outfile)
      else:
        logging.error(
