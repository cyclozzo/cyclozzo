...
- url: /_ah/queue/deferred
  script: $PYTHON_LIB/cyclozzo/apps/ext/deferred/handler.py
  login: admin
...
from cyclozzo.apps.api.labs import taskqueue
...
def main():
  if os.environ["SERVER_SOFTWARE"].startswith("Devel"):
    logging.warn("You are using deferred in a deprecated fashion. Please change"
                 ...
                 " to $PYTHON_LIB/cyclozzo/apps/ext/deferred/handler.py to"
